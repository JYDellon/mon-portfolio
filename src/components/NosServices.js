...
const NosServices = () => {
  ...
  useEffect(() => {
    console.log("Visite enregistrée pour la page NosServices");  // Ajout d'un log pour le débogage
    axios.post('http://localhost:8000/api/visit/nos-services', { // Remplacez l'URL par celle de votre API
      page: 'nos-services', // Le nom de la page à enregistrer
    })
    .then(response => {
