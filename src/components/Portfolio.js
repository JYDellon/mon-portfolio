...
function Portfolio() {
    ...
    useEffect(() => {
        console.log("Visite enregistrée pour la page Portfolio");  // Ajoutez un log ici
        axios.post('http://localhost:8000/api/visit/portfolio', { // Assurez-vous que l'URL correspond à votre backend
            page: 'portfolio', // Le nom de la page à enregistrer
        })
        .then(response => {
